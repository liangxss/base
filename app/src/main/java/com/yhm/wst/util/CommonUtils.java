...
//		String regex = "http(s)?:\\/\\/([\\w-]+\\.)+[\\w-]+(\\/[\\w- .\\/?%&=]*)?";
	...
	public static void HPFail(Context mContext, String error, String error_msg) {
		toast(mContext, error_msg);
	}

	public static void HPError(Context mContext, Throwable throwable) {
		if(throwable.toString().contains("Login")) {
//			CommonPreference.clearLocalData();
